...
class RotatingObject:
    def __init__(self, image, pos):
        ...
        self.angle = 0
        self.rotateSpeed = random.uniform(0.1, 0.5)  # random speed of rotation
    def update(self):
...
def createObject():
    global rotating_objects
    rotating_objects = [
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (150, 150)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (300, 400)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (SCREEN_WIDTH - 150, 150)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (SCREEN_WIDTH - 300, 400)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (200, 100)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (SCREEN_WIDTH - 200, 100)),
        RotatingObject(BACKGROUND_ASSETS[random.randint(0,int(len(BACKGROUND_ASSETS)-1))], (SCREEN_WIDTH // 2, 100))
    ]
